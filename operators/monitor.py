...
Collects news from ArchDaily RSS, summarizes with AI, sends to Telegram.
...
async def main():
    """Main execution flow."""
    print("=" * 50)
    print("🏗️ ArchDaily News Monitor")
    ...
    try:
        bot = TelegramBot()
        results = await bot.send_digest(summarized_articles, "ArchDaily")
